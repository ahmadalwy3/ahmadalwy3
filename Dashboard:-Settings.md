...
#### **IMPORTANT NOTE:**
On Chromium 51 and above (including browsers based on Chromium 51 and above), this setting does not block all DNS lookups, preconnections and prefetches. For details, see:
